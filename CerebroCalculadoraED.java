...
public class CerebroCalculadoraED {
	...
	public void operarSumaRes(Operaciones op) {
		infoOperacion(op);
		pedirUnNumero();
		this.setResultado(this.getResultado() + this.numero2);
		mostrarResultado(op);
		anadirHistorial(op);
	}
	...
	public void mostrarResultadoActual(Operaciones op) {
		infoOperacion(op);
		System.out.println("El valor actual del resultado es: " + this.getResultado() + "\n");
	}
	
	public void numeroAleatorio(Operaciones op) {
		infoOperacion(op);
		this.setResultado((double)(Math.random()*100+1));
		System.out.println("El número aleatorio generado es: " + this.getResultado() + "\n");
	...
	public void pedirUnNumero() {
		...
		this.numero1 = this.getResultado();
